  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div>
          {product.brand && (
            <div className="text-xs font-semibold text-[#5FA8D3] mb-1.5 uppercase tracking-wide">
              {product.brand}
            </div>
          )}
          <div className="text-xs text-[#A6A6A6] mb-2">REF. {product.sku}</div>
          <h1 className="text-xl md:text-2xl font-bold text-[#2E2E2E] mb-4 font-heading">
            {product.name}
          </h1>

          <div className="text-2xl md:text-3xl font-extrabold text-[#1B3A57] mb-1 font-heading">
          ...
          <div
            className={`text-xs font-semibold mb-5 ${
              !outOfStock ? 'text-green-700' : 'text-[#E0212B]'
            }`}
          >
            {!outOfStock
          ...
          {outOfStock ? (
            ...
            <>
              ...
              <button
                ...
                className="bg-[#E0212B] text-white px-6 py-3 rounded-lg font-semibold text-sm w-full md:w-auto"
              >
                Ajouter au panier
              </button>
            </>
